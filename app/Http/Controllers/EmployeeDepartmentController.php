...
class EmployeeDepartmentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/department/create')->with('success','Department has been added.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/department/'.$id.'/edit')->with('success','Department has been updated.');
    }
