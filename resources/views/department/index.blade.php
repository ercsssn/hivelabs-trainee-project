                        ...
                        @if ($data)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this room?')" href="{{ url('admin/department/'.$d->id).'/delete' }}"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        @endif
