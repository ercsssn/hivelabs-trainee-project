                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Rent Records
                                <a href="{{url('admin/rent/create')}}" class="float-right btn btn-success btn-sm">Add New</a>
                            </h6>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$rent->id}}</td>
                                            <td>{{$rent->tenant->full_name ?? 'unknown'}}</td>
                                            <td>{{$rent->room->title ?? 'unknown'}}</td>
